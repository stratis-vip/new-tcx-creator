...
//   ASSERT_THAT((a + b).value(), Eq("346866701642557678085.4410912656429933287"));
// }

TEST(stringAdd, add1and1){
  ASSERT_THAT(stringAdd("1","1"), Eq("2"));
}

TEST(stringAdd, add1and10){
  ASSERT_THAT(stringAdd("1","10"), Eq("11"));
}

TEST(stringAdd, add67and58){
  ASSERT_THAT(stringAdd("67","58"), Eq("125"));
}

TEST(stringAdd, add346743244898234223542and123456744323454542){
  ASSERT_THAT(stringAdd("346743244898234223542","123456744323454542"), Eq("346866701642557678084"));
}

TEST(stringAdd, add34466467432448982342884573622423542and12345674432567567567573535092343454542){
  ASSERT_THAT(stringAdd("34466467432448982342884573622423542","12345674432567567567573535092343454542"), Eq("12380140900000016549916419665965878084"));
}
...
TEST(stringAdd, add2andminus1){
  ASSERT_THAT(stringAdd("2","-1"), Eq("1"));
}

TEST(stringAdd, add1andminus2){
  ASSERT_THAT(stringAdd("1","-2"), Eq("-1"));
}
